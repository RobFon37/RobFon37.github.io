...
var myChart = new Chart(ctx, {
  ...
  data: {
    labels: binomdata[1],
    datasets: [{  
      label: 'Binomial distribution, n = ' + N.toString() + ' , p = ' + P.toFixed(2).toString(),
      data: binomdata[0],
    ...
    label: 'Normal distribution, μ = ' + mu.toString() + ' , σ = ' + sigma.toString(),
    data: normdata,
    type: 'line',
    xAxisID: 'normx',
    yAxisID: 'normy',
...
function drawchart(N,P){
  ...
  myChart.data.datasets[0].label = 'Binomial distribution, n = ' + N.toString() + ' , p = ' + P.toFixed(2).toString();
  myChart.data.datasets[1].label = 'Normal distribution, μ = ' + mu.toString() + ' , σ = ' + sigma.toString(); 
